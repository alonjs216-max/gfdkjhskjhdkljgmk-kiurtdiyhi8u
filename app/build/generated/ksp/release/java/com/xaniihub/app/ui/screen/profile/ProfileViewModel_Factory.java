...
public final class ProfileViewModel_Factory implements Factory<ProfileViewModel> {
  ...
  public ProfileViewModel_Factory(Provider<XaniiRepository> repositoryProvider) {
  ...
  public static ProfileViewModel_Factory create(Provider<XaniiRepository> repositoryProvider) {
    return new ProfileViewModel_Factory(repositoryProvider);
  }

  public static ProfileViewModel newInstance(XaniiRepository repository) {
